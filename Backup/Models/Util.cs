...
namespace MPXMobile.Models
{
    ...
    public class Util
    {
        ...
        public static WipService.MpxWebServicesPort Port()
        {
            ...
            credentials.password = System.Configuration.ConfigurationSettings.AppSettings["LogU"];
            credentials.userName = System.Configuration.ConfigurationSettings.AppSettings["LogP"];
