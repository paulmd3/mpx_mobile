...
<asp:Content ID="changePasswordTitle" ContentPlaceHolderID="TitleContent" runat="server">
    X Nonprofit MPX-Change Password
</asp:Content>
    ...
    <div>
        <fieldset>
            ...
            <p>
                ...
                <%= Html.Password("currentPassword" , "", new { @class = "text-long" }) %>
                <%= Html.ValidationMessage("currentPassword") %>
            </p>
            <p>
                <label for="newPassword">
                    New password:</label>
                <%= Html.Password("newPassword" , "", new { @class = "text-long" }) %>
            ...
            <p>
                <input class="forward grayButton" type="submit" value="Change" />
            </p>
        </fieldset>
    </div>
    <% } %>
